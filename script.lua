...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("SAIKI Hub Premium Scripts") then
			makefolder("SAIKI Hub Premium Scripts")
		end
		if not isfolder("SAIKI Hub Premium Scripts/Blox Fruits/") then
			makefolder("SAIKI Hub Premium Scripts/Blox Fruits/")
		end
		if not isfile("SAIKI Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("SAIKI Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("SAIKI Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("SAIKI Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("SAIKI Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
...
if QuestC.Visible == true then
						...
						local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/minhhau207/SAIKIHub/main/obfuscated-3788.lua"))()
